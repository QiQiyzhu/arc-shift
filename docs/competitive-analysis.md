...
| --- | --- | --- |
| [The Binding of Isaac: Rebirth](https://store.steampowered.com/app/250900/The_Binding_of_Isaac_Rebirth/) / [Repentance](https://store.steampowered.com/app/1426300/The_Binding_of_Isaac_Repentance/) | 道具改变攻击行为，多种效果共同形成构筑 | v0.2 将形态、弹道、命中载荷分层叠加，再增加六种跨系反应与试炼；这是本项目的设计推导 |
...
三张候选排除已持有与无法触发的前置卡，优先补齐跨系反应，再偏向已发展元素并保留探索选项。把战斗随机数和奖励随机数分开，方便重现问题。v0.2 重点演示的是弹体行为组合：例如分裂、反弹、追踪、波动可同时出现；不照搬参考作品的具体道具表或数值。
